...
return function(Signal)
	...
	local DarkTheme = {
		...
		Colors = {
			...
			SurfaceHovered = Color3.fromRGB(30, 30, 36),
			SurfaceActive = Color3.fromRGB(38, 38, 45),
			Accent = Color3.fromRGB(145, 110, 255),
			AccentHovered = Color3.fromRGB(160, 125, 255),
			AccentActive = Color3.fromRGB(125, 90, 240),
			AccentDark = Color3.fromRGB(105, 70, 220),
			AccentSubtle = Color3.fromRGB(45, 35, 75),
			Text = Color3.fromRGB(245, 245, 250),
			TextSecondary = Color3.fromRGB(180, 180, 190),
			TextDimmed = Color3.fromRGB(150, 150, 160),
			TextDisabled = Color3.fromRGB(90, 90, 100),
			TextInverse = Color3.fromRGB(15, 15, 18),
			Border = Color3.fromRGB(40, 40, 48),
			BorderHovered = Color3.fromRGB(55, 55, 65),
			BorderAccent = Color3.fromRGB(145, 110, 255),
			Glow = Color3.fromRGB(145, 110, 255),
			Shadow = Color3.fromRGB(0, 0, 0),
			Success = Color3.fromRGB(80, 200, 120),
			Warning = Color3.fromRGB(240, 180, 40),
			Error = Color3.fromRGB(230, 70, 70),
			Info = Color3.fromRGB(70, 150, 255),
			Scrollbar = Color3.fromRGB(40, 40, 48),
			ScrollbarHovered = Color3.fromRGB(55, 55, 65),
			ScrollbarActive = Color3.fromRGB(80, 80, 95),
