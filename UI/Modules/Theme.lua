...
return function(Signal)
	...
	local DarkTheme = {
		...
		Colors = {
			...
			BackgroundSecondary = Color3.fromRGB(14, 14, 18),
			BackgroundTertiary = Color3.fromRGB(18, 18, 24),
			Surface = Color3.fromRGB(16, 16, 20),
			SurfaceHovered = Color3.fromRGB(24, 24, 30),
			SurfaceActive = Color3.fromRGB(32, 32, 40),
			Accent = Color3.fromRGB(160, 125, 255),
			AccentHovered = Color3.fromRGB(175, 145, 255),
			AccentActive = Color3.fromRGB(140, 105, 240),
			AccentDark = Color3.fromRGB(115, 80, 220),
			AccentSubtle = Color3.fromRGB(35, 25, 60),
			...
			TextInverse = Color3.fromRGB(10, 10, 12),
			Border = Color3.fromRGB(30, 30, 38),
			BorderHovered = Color3.fromRGB(45, 45, 55),
			BorderAccent = Color3.fromRGB(160, 125, 255),
			Glow = Color3.fromRGB(160, 125, 255),
			Shadow = Color3.fromRGB(0, 0, 0),
			Success = Color3.fromRGB(80, 220, 130),
			Warning = Color3.fromRGB(250, 190, 50),
			Error = Color3.fromRGB(240, 80, 80),
			Info = Color3.fromRGB(80, 160, 255),
			Scrollbar = Color3.fromRGB(35, 35, 45),
			ScrollbarHovered = Color3.fromRGB(50, 50, 65),
			ScrollbarActive = Color3.fromRGB(75, 75, 90),
